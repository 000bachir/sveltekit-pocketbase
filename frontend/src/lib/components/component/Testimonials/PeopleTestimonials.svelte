...
<section id="testimonials-container" class="relative flex h-[800px] w-full items-center justify-center">
		...
		<div class="innerdiv">
			...
			<div class="div1 eachdiv rounded-xl px-6 py-4 text-white">
				...
				<div class="review">
					...
					<p>
						“I've been buying games online for years, but this store stands out. The website is
						user-friendly, and I found some rare titles I've been hunting for ages. Shipping was
			...
			<div class="div3 eachdiv rounded-xl px-6 py-4 text-white">
				...
				<div class="review dark">
					<h4>Excellent customer service and game selection!</h4>
					<p>
						“This e-store exceeded my expectations. Not only did they have a vast selection of
						games, but their customer service was also exceptional. I had an issue with my order,
						and they resolved it within hours. The game prices are competitive, and the special
						deals are a great bonus. Highly recommend!”
					</p>
				</div>
			</div>
			<!-- div4 -->
			...
			<div class="div5 eachdiv rounded-xl px-6 py-4 text-white">
				...
				<div class="review">
					<h4>A one-stop shop for all my gaming needs!</h4>
					<p>
						“From the latest releases to beloved classics, this store has it all. I appreciate the
						detailed descriptions and reviews that help me make informed decisions. The purchasing
